 ...
 * 
 * Input 
 * The first line contains a positive integer n (1 ≤ n ≤ 100), then follow
 * n lines containing three integers each: the xi coordinate, the yi coordinate
 * and the zi coordinate of the force vector, applied to the body
 * ( - 100 ≤ xi, yi, zi ≤ 100).
 * 
 * Output 
 ...
 * YES
 * 
 * @Title: A69YoungPhysicist.java
 * @author lxh
 * @date Aug 26, 2015 9:39:22 AM
 * 
 */
