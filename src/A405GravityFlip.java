...
/**
 * Little Chris is bored during his physics lessons (too easy), so he has built
 * a toy box to keep himself occupied. The box is special, since it has the
 ...
 * 
 * Input 
 * The first line of input contains an integer n (1 ≤ n ≤ 100), the number
 * of the columns in the box. The next line contains n space-separated integer
 * numbers. The i-th number ai (1 ≤ ai ≤ 100) denotes the number of cubes in the
 * i-th column.
 * 
 * Output 
 * Output n integer numbers separated by spaces, where the i-th number is
 * the amount of cubes in the i-th column after the gravity switch.
 * 
 * Sample test(s) 
 * input 
 * 4 
 ...
 * the columns.
 * 
 * @Title: A405GravityFlip.java
 * @author lxh
 * @date Sep 1, 2015 8:39:41 PM
 * 
 */
