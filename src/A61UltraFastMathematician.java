 ...
 * corresponding to the given pair of numbers. The rule is simple: The i-th
 * digit of the answer is 1 if and only if the i-th digit of the two given
 ...
 * perform these operations on numbers of length ¡Þ (length of a number is number
 ...
 * 
 * Input 
 * There are two lines in each input. Each of them contains a single
 * number. It is guaranteed that the numbers are made from 0 and 1 only and that
 * their length is same. The numbers may start with 0. The length of each number
 * doesn't exceed 100.
 * 
 * Output 
 * Write one line ¡ª the corresponding answer. Do not omit the leading 0s.
 * 
 * Sample test(s) 
 * input 
 * 1010100 
 ...
 * 00010
 * 
 * @Title: A61UltraFastMathematician.java
 * @author lxh
 * @date Aug 26, 2015 9:49:01 AM
 * 
 */
...
public class A61UltraFastMathematician {
	public static void main(String []args){
		...
		int l=s1.length();
		for(int i=0;i<l;i++){
			if(s1.charAt(i)==s2.charAt(i))str+="0";
			else
				str+="1";
		}
