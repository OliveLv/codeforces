 ...
 * 
 * Input 
 * The first and only line contains positive integers n, k, l, c, d, p,
 * nl, np, not exceeding 1000 and no less than 1. The numbers are separated by
 * exactly one space.
 * 
 * Output 
 ...
 * make 20 / 3 = 6 toasts. The limes are enough for 10 * 8 = 80 toasts and the
 * salt is enough for 100 / 1 = 100 toasts. However, there are 3 friends in the
 * group, so the answer is min(6, 80, 100) / 3 = 2.
 * 
 * @Title: A151SoftDrinking.java
 * @author lxh
 * @date Oct 28, 2015 8:01:52 AM
 * 
 */
