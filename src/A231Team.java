 ...
 * number of problems in the contest. Then n lines contain three integers each,
 ...
 * output
 * 1 
 * Note In the first sample Petya and Vasya are sure that they know how to
 * solve the first problem and all three of them know how to solve the second
 * problem. That means that they will write solutions for these problems. Only
 * Petya is sure about the solution for the third problem, but that isn't
 * enough, so the friends won't take it.
 * 
