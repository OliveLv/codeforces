 ...
 * word ViP ¡ª with VIP. If a word contains an equal number of uppercase and
 ...
 * 
 * Input 
 * The first line contains a word s ¡ª it consists of uppercase and
...
public class A59Word {
	public static void main(String []args){
		...
		if(ln>=un)System.out.println(s.toLowerCase());
		else
