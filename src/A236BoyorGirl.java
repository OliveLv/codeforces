 ...
 * 
 * Input 
 * The first line contains a non-empty string, that contains only
 * lowercase English letters ¡ª the user name. This string contains at most 100
 * letters.
 * 
 * Output 
 ...
 * CHAT WITH HER! 
 * Note 
 * For the first example. There are 6 distinct characters in "wjmzbmr". These characters are:
 * "w", "j", "m", "z", "b", "r". So wjmzbmr is a female and you should print
 * "CHAT WITH HER!".
 * 
 * @Title: A263BoyorGirl.java
 * @author olive
 * @date Aug 14, 2015 10:03:10 AM
 * 
 */
