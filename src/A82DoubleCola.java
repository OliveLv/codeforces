 ...
 * Leonards, and so on. This process continues ad infinitum.
 * 
 ...
 * 
 * Output 
 * Print the single line — the name of the person who drinks the n-th can
 * of cola. The cans are numbered starting from 1. Please note that you should
 * spell the names like this: "Sheldon", "Leonard", "Penny", "Rajesh", "Howard"
 ...
 * Penny
 * 
 * @Title: A82DoubleCola.java
 * @author olive
 * @date Aug 14, 2015 10:16:50 AM
 * 
 */
// 指数增长
public class A82DoubleCola {
	public static void main(String[] args) {
		...
		long sum = 0;
		/*
		 * while(true){ sum+=now; if(sum>=n)break; now*=2; }
		 */
		for (now = 1;; now *= 2) {
			sum += 5 * now;
			if (sum >= n)
