 ...
 * 
 * 1+2*3=7 1*(2+3)=5 1*2*3=6 (1+2)*3=9 Note that you can insert operation signs
 * only between a and b, and between b and c, that is, you cannot swap integers.
 ...
 * 
 * Input 
 * The input contains three integers a, b and c, each on a single line
 * (1 ≤ a, b, c ≤ 10).
 * 
 * Output 
 ...
 * 60
 * 
 * @Title: A479Expression.java
 * @author lxh
 * @date Aug 26, 2015 9:53:47 AM
 * 
 */
