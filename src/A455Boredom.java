 ...
 * 
 * Input 
 * The first line contains integer n (1 ≤ n ≤ 105) that shows how many
 * numbers are in Alex's sequence.
 * 
 * The second line contains n integers a1, a2, ..., an (1 ≤ ai ≤ 105).
 * 
 * Output 
 * Print a single integer — the maximum number of points that Alex can
 * earn.
 * 
 * Sample test(s) 
 * input 
 ...
 * 10 
 * Note 
 * Consider the third test example. At first step we need
 * to choose any element equal to 2. After that step our sequence looks like
 * this [2, 2, 2, 2]. Then we do 4 steps, on each step we choose any element
 * equals to 2. In total we earn 10 points.
 * 
...
public class A455Boredom {
	...
	public static void main(String []args){
		...
		for(int i=2;i<N;i++){
			BigInteger tmp=max(b,a.add(new BigInteger(String.valueOf(cnt[i]*i))));
			a=b;
			b=tmp;
		}
